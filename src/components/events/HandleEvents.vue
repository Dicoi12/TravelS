<template>
    ...
    <Dialog
      ...
      maximizable
      modal
      :header="eventStore.selectedEvent.id == 0 ? 'Adaugă eveniment' : 'Editează eveniment'"
      :style="{ width: '50rem' }"
    ...
    >
      <div class="flex justify-content-center flex-column">
        ...
        <InputText
          v-model="eventStore.selectedEvent.name"
          label="Nume"
        />
      </div>
      <div class="flex justify-content-center flex-column">
        ...
        <InputText
          v-model="eventStore.selectedEvent.city"
          label="Oraș"
        />
      </div>
      <div class="flex justify-content-center flex-column">
      ...
      <Map
        ...
        class="mt-2"
        v-if="
          eventStore.selectedEvent.latitude &&
          eventStore.selectedEvent.longitude
        "
      />
      <div class="flex justify-content-end mt-2">
        <Button
          icon="pi pi-plus"
          :label="
            eventStore.selectedEvent.id == 0 ? 'Adaugă' : 'Editează'
          "
          @click="
